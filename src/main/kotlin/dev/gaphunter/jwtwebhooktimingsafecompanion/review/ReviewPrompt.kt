package dev.gaphunter.jwtwebhooktimingsafecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.jwtwebhooktimingsafecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.jwtwebhooktimingsafecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "JWT Webhook Signature Timing-Safe Comparison Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33998-jwt-webhook-signature-timing-safe-comparison-companion/reviews"
